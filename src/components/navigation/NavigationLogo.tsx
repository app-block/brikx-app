  ...
  return (
    ...
    >
      <div className="relative">
        {/* Main logo */}
        <div className="w-9 h-9 sm:w-11 sm:h-11 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-lg sm:text-xl shadow-md group-hover:bg-blue-700 transition-all duration-200 group-hover:scale-105">
          <span>B</span>
        </div>
      </div>
